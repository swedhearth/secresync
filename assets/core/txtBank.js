...
"remoteLoadOrNew": {
  ...
  "i": "${sKey}"
    ...
    "message": {
      ...
      "loadBd": "Load an existing database or create a new one.",
...
"remoteLoadOrNew": {
  ...
  "i": "${sKey}"
    ...
    "message": {
      ...
      "loadBd": "Cargue una base de datos existente o cree una nueva.",
...
"remoteLoadOrNew": {
  ...
  "i": "${sKey}"
    ...
    "message": {
      ...
      "loadBd": "Chargez une base de données existante ou créez-en une nouvelle.",
...
"remoteRedirectWithClipboard": {
  ...
  "i": "${ sKey }"
    ...
    "message": {
      ...
      "loadBd": "Załaduj istniejącą bazę danych lub utwórz nową.",
